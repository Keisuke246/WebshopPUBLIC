	...
	<div id="header">																																																																																																																																																																																																				<div class="inner_copy"></div>
		...
		<div class="topblock2">
			<img src='<spring:url value="/images/shopping.gif"/>' alt="" width="24" height="24" class="shopping" />
			 ...
			 <p><strong>${nbArticlesTotal}</strong> <span><spring:message code="items"/></span></p>
		 	<c:if test="${currentUser.prenom != null}">Welcome ${currentUser.prenom}</c:if>
		</div>
		<ul id="menu">
	  ...
	  <div id="right" class="column">
		<div class="rightblock">
			...
			<div class="blocks">
				...
				<a href="<spring:url value='/connexion'/>"><p><spring:message code="login"/></p></a>
